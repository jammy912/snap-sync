...
App.app = (function () {
  ...
  // 預設【關閉】——拍照頁中間已經是整片大圖，拍完那張立刻顯示在那裡，
  // 再疊一層檢視器只是多一次關閉動作，連拍時更礙事。
  // 想要更大（可再放大、直接刪除）的人才開。
  var settings = { maxEdge: 1600, quality: 0.8, autoReview: false };
  ...
  function loadSettings() {
    ...
    $('autoReview').checked = settings.autoReview === true;
